functions{
  ...
  row_vector get_duration(int[] Rating, real[] Days, real[] Sentiment, int T , int S , real[] l_pi , real[,] l_tpm , real[,] emission, real[] intercept, real lambda, real gamma, real epsilon){
    vector[S] forw[T];
    vector[S] duration[T];
    vector[S] temp_tpm[S];
    vector[T] c;
  ...
  row_vector get_duration_day(int[] Rating, real[] Days, real[] Sentiment, int T , int S , real[] l_pi , real[,] l_tpm , real[,] emission, real[] intercept, real lambda, real gamma, real epsilon){
    vector[S] forw[T];
    vector[S] duration[T];
  ...
  row_vector[] get_duration_all(int[] Rating, real[] Days, real[] Sentiment, int T , int S , real[] l_pi , real[,] l_tpm , real[,] emission, real[] intercept, real lambda, real gamma, real epsilon){
    vector[S] forw[T];
